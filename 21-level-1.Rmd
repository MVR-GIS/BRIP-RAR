...
## Project Timeline
```{r, echo=FALSE, warning=FALSE, message=FALSE}
item_style <- "font-size: 0.7em; line-height: 0.5; background: #ffe6b3; border-color: #006600;"
