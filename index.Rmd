...
# remove me???source("R/convert_date.R")
...
# Remove test data
risk <- rarr::remove_test_records(risk, "RISK_NO")
...
# Remove test records
events <- rarr::remove_test_records(events_oracle, "FK_TABLE_ID") 
...
# Remove test records
discussion <- rarr::remove_test_records(discussion_oracle, "FK_TABLE_ID")
...
# Remove test records
action <- rarr::remove_test_records(action_oracle, "ACTION_NO")
...
# Remove test records
decision <- rarr::remove_test_records(decision_oracle, "DECISION_NO")
...
# Remove test records
rel_action_action <- rarr::remove_test_records(rel_action_action_oracle, "ACTION_NO")
rel_action_action <- rarr::remove_test_records(rel_action_action, "RELATED_ACTION")
...
# Remove test records
rel_dec_action <- rarr::remove_test_records(rel_dec_action_oracle, "DECISION_NO")
...
# Remove test records
rel_dec_dec <- rarr::remove_test_records(rel_dec_dec_oracle, "DECISION_NO")
...
# Remove test records
rel_risk_action <- rarr::remove_test_records(rel_risk_action_oracle, "RISK_NO")
rel_risk_action <- rarr::remove_test_records(rel_risk_action, "ACTION_NO")
...
# Remove test records
rel_risk_dec <- rarr::remove_test_records(rel_risk_dec_oracle, "RISK_NO")
rel_risk_dec <- rarr::remove_test_records(rel_risk_dec, "DECISION_NO")
...
# Cleanup id fields for sorting
rel_risk_dec <- rarr::format_id(rel_risk_dec, "RISK_NO")
rel_risk_dec <- rarr::format_id(rel_risk_dec, "DECISION_NO")

# Create hyperlink
rel_risk_dec <- rarr::id_link(rel_risk_dec, "risk_no")
rel_risk_dec <- rarr::id_link(rel_risk_dec, "decision_no")
...
# Remove test records
rel_risk_risk <- rarr::remove_test_records(rel_risk_risk_oracle, "RISK_NO")
rel_risk_risk <- rarr::remove_test_records(rel_risk_risk, "RELATED_RISK")
...
# Cleanup id numbers for sorting
rel_risk_risk <- rarr::format_id(rel_risk_risk, "RISK_NO")
rel_risk_risk <- rarr::format_id(rel_risk_risk, "RELATED_RISK")

# Create hyperlink to Related Risk
rel_risk_risk <- rarr::id_link(rel_risk_risk, "related_risk")
